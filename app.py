...
/* Click */
.kpi-button button:active {
    transform: translateY(-1px) !important;

    box-shadow:
        0 5px 12px rgba(37,99,235,.13) !important;
}

/* Focus */
.kpi-button button:focus,
.kpi-button button:focus-visible {
    ...
    box-shadow:
        ...
        0 8px 20px rgba(37,99,235,.14) !important;
}
...
# =========================================================
# REMOVE OLD RESULT WHEN FILES NOT UPLOADED
# =========================================================
...
if not two_b_file or not books_file:
    ...
    st.write(
        "Upload your GSTR-2B and Purchase Register Excel files "
        "above to reconcile your ITC automatically."
    )
